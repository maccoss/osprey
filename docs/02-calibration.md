...
4. Detect candidate peaks using **CWT consensus peak detection** (Mexican Hat wavelet convolution of each fragment XIC, pointwise median across transitions — see [Peak Detection](05-peak-detection.md))
...
See [FDR Control](07-fdr-control.md) for full details on the target-decoy strategy.
